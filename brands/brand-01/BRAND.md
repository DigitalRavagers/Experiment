...
> Copy this file to `brands/brand-01/BRAND.md` and fill in all sections before activating any agent for this brand.
...
- Design tokens: `brands/brand-01/design-system/tokens.json`
- Logo: `brands/brand-01/design-system/assets/logo.*`
- Color palette: See tokens.json
- Typography: See tokens.json

## Active Workflows

List active n8n workflows in `brands/brand-01/workflows/`.
