...
> Copy this file to `brands/brand-XX/BRAND.md` and fill in all sections before activating any agent for this brand.
...
- Design tokens: `brands/brand-XX/design-system/tokens.json`
- Logo: `brands/brand-XX/design-system/assets/logo.*`
- Color palette: See tokens.json
- Typography: See tokens.json

## Active Workflows

List active n8n workflows in `brands/brand-XX/workflows/`.
